...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_tower_drop p_tower_drop;
        ...
        public static SteamVR_Input_ActionSet_tower_drop tower_drop
        {
            get
            {
                return SteamVR_Actions.p_tower_drop.GetCopy<SteamVR_Input_ActionSet_tower_drop>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_tower_drop = ((SteamVR_Input_ActionSet_tower_drop)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_tower_drop>("/actions/tower drop")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.tower_drop};
        }
    }
}
